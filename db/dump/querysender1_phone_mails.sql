...
CREATE TABLE `phone_mails` (
  ...
  `phones` set('') DEFAULT NULL,
  `users_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_phone_mails_users1_idx` (`users_id`),
  CONSTRAINT `fk_phone_mails_users1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `phone_mails`
--

LOCK TABLES `phone_mails` WRITE;
