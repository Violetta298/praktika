module.exports = {
    1 : (name, linkToSite, title, text1, text2, link1, link1text, link2, link2text, link3, link3text) => {
        return `
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                          ...
                          <tr>
                            <td style="padding-bottom:20px;">
                                ${text1}
                              <b><a class="blue-link" href="#"><hr /></a></b>
                                ${text2}
                            </td>
                          </tr>
                        </table>
